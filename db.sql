...
insert into FULL_UNIVERSIDAD.personas values (101409872,'CAMILO','BERMUDEZ','1992/11/12/',3202746,'CARRERA 13');
insert into FULL_UNIVERSIDAD.personas values (101409873,'FELIPE','QUINTERO','1994/11/03',2743513,'CARRERA 14');
insert into FULL_UNIVERSIDAD.personas values (101409874,'ROSA','BERMUDEZ','1994/03/05',2743514,'CARRERA 15');
insert into FULL_UNIVERSIDAD.personas values (101409875,'TOMAS','CARDENAS','1992/04/16',2743515,'CARRERA 16');
insert into FULL_UNIVERSIDAD.personas values (101409876,'ANDRES','ROSALES','1994/02/19',2743516,'CARRERA 17');
insert into FULL_UNIVERSIDAD.personas values (101409877,'SEBASTIAN','TORRES','1992/12/19',2743517,'CARRERA 18');
insert into FULL_UNIVERSIDAD.personas values (101409878,'JOSE','RUIZ','1992/11/19',2743518,'CARRERA 19');
